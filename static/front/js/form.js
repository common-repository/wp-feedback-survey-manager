    ...
    if($('.toggle_f input[type="checkbox"]').length) {
        ...
        $('.toggle_f input[type="checkbox"]').each(function() {
            if($(this).attr('checked')) {
                $(this).parent().parent().parent().siblings('div.toggle_d').show();
            } else {
                $(this).parent().parent().parent().siblings('div.toggle_d').hide();
            }
        });

        $('.toggle_f input[type="checkbox"]').change(function() {
            var target = $(this).parent().parent().parent().siblings('div.toggle_d');
            if(this.checked) {
